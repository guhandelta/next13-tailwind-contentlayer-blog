    ...
    return (    
        <div className="group flex flex-col items-center text-black">
            ...
            <div className="w-full flex flex-col mt-4">
                <span className=" uppercase text-purple-800 font-bold font-rh text-md">{blog.tags[0]}</span>
                <Link href={blog.URL} className='inline-block my-1'>
                    <h2 className='font-semibold capitalize text-lg'>
                        <span className="bg-gradient-to-r font-mr from-purple-800/60 to-purple-950/60 bg-[length:0px_6px] group-hover:bg-[length:100%_6px] bg-left-bottom bg-no-repeat transition-[background-size] duration-500 text-xl">
                            {blog.title}
                        </span>
                    </h2>
                </Link>
